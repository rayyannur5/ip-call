...
try {
    ...
    foreach ($res as $key => $value) {
        array_push($array,[$value['id'], $value['name'], $value['username'], $value['duration'], $value['timestamp']]);
    }
    ...
    $filename = "EXCEL_RIWAYAT_TELEPON_" . date("Y-m-d H:i:s");
