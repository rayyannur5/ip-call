    ...
    <div class="col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
                ...
                <form id="backupForm" action="{{ route('backup_restore.run') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-primary w-100 py-2 fs-6 shadow-sm btn-action">
...
<script>
    $(document).ready(function() {
        ...
        $('#backupForm').on('submit', function() {
            ...
            btn.html('<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>Mengompresi data...');
            
            // Re-enable button after some time (since download starts asynchronously/triggers browser save dialogue)
            setTimeout(function() {
