            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        ...
                        <a href="{{ url('/ip-call/admin/running-text/destroy/' . $text->topic) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/ip-call/admin/running-text/store') }}" method="POST">
                @csrf
...
<script>
    function updateRow(topic) {
        ...
        form.action = "{{ url('/ip-call/admin/running-text/update') }}/" + topic;
