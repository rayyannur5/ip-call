...
@php
    $endpointUrls = $oximonitorUrls ?? [
        'metrics' => url('/ip-call/admin/oximonitor/metrics'),
        'currentFlow' => url('/ip-call/admin/oximonitor/current-flow'),
        'data' => url('/ip-call/admin/oximonitor/data'),
        'export' => url('/ip-call/admin/oximonitor/export'),
    ];
@endphp
