...
// All routes under /ip-call prefix
Route::prefix('ip-call')->group(function () {
    ...
    Route::get('/monitor', function () {
        return redirect('/ip-call/oximonitor');
    })->middleware('auth');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'restrict.oximonitor.admin'], function () {
        ...
        // Backup download endpoint (made public GET for direct download intercept)
        Route::get('/backup-restore/run', [BackupRestoreController::class, 'backup'])->name('backup_restore.run');
    });
