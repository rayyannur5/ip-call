...
class RunningTextController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/ip-call/admin/running-text')->with('success', 'Running Text created successfully.');
    }
    ...
    public function update(Request $request, $topic)
    {
        ...
        return redirect('/ip-call/admin/running-text')->with('success', 'Running Text updated successfully.');
    }
    ...
    public function destroy($topic)
    {
        ...
        return redirect('/ip-call/admin/running-text')->with('success', 'Running Text deleted successfully.');
    }
}
