                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-switch custom-switch-off-disabled custom-switch-on-primary ">
                                                                            <input type="checkbox" class="custom-control-input" name="tw" id="switch-tw-<?= $bed["id"] ?>" <?= $bed["tw"]
    ? "checked"
    : "" ?>>
                                                                    ...
                                                                    <label class="form-label" id="label-volume-range-<?= $bed["id"] ?>" for="ubah-volume-range-<?= $bed["id"] ?>">Volume : <?= $bed[
    "vol"
] ?></label>
                                                                    <div class="range">
